...
type Variant = "primary" | "secondary" | "outline" | "ghost" | "ghost-white" | "dark" | "white";
type Size = "sm" | "md" | "lg";
...
const variants: Record<Variant, string> = {
  ...
  secondary:
    "bg-white text-[var(--color-brand-primary)] border border-[var(--color-brand-primary)] hover:bg-[var(--color-brand-mint)]/20",
  outline:
  ...
  dark: "bg-[#0f1f18] text-white hover:bg-black",
  white: "bg-white text-[var(--color-brand-primary)] hover:bg-white/90",
};
